...
# creates a list of list to hold all of the initial values for the board when the code starts running; the grey pegs not be visible until the codebreaker finishes a row
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_UP:
                print("Up Arrow")
                # if the color is initially white, it assigns it to the first color in the codebreaker_colors list and updates the board
